...
CREATE TABLE IF NOT EXISTS posts (
  ...
  post_type      ENUM('NOTE','VR_MEDIA','ROUTE','JOURNEY','GUIDE','MOMENT') NOT NULL DEFAULT 'NOTE' COMMENT '帖子类型',
  community_id   VARCHAR(36) NULL COMMENT '关联社群ID',
  content_level  ENUM('SNAPSHOT','CLASSIFIED','DIARY','ESSAY') NOT NULL DEFAULT 'SNAPSHOT' COMMENT '内容层级',
