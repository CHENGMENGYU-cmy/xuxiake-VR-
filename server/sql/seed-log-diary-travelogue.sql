-- ============================================================
-- 闪拍 / 日记 / 游记 种子数据（3级内容链条）
-- 仅普通用户 (role='USER')，不含管理员
-- 每个普通用户：1条SNAPSHOT(闪拍素材) + 1条DIARY(可发日记) + 1条TRAVELOGUE(游记)
-- ============================================================
...
INSERT INTO posts (id, author_id, post_type, content_level, parent_post_id, content, title, location_name, vr_metadata, visibility, like_count, comment_count, view_count, created_at) VALUES
(@travelogueId, @userId, 'JOURNEY', 'TRAVELOGUE', @diaryId,
 ...
 '{"keywords":["漓江","阳朔","延时摄影","日出","桂林山水","旅行摄影"],"sourceSnapIds":["__SNAP_ID__"],"sourceDiaries":["__DIARY_ID__"],"prompt":"根据今天的拍摄日志和心情日记，写一篇漓江光影旅行游记，包含实用旅行提示","style":"诗意散文风","aiGenerated":true}',
 'PUBLIC', 0, 0, 0, '2026-08-04 22:00:00');

UPDATE posts SET vr_metadata = REPLACE(REPLACE(vr_metadata, '"__SNAP_ID__"', CONCAT('"', @snapId, '"')), '"__DIARY_ID__"', CONCAT('"', @diaryId, '"')) WHERE id = @travelogueId;
...
(@travelogueId, @userId, 'JOURNEY', 'TRAVELOGUE', @diaryId,
 ...
 '{"keywords":["VR测评","西湖","空间视频","摄影技巧","科技人文"],"sourceSnapIds":["__SNAP_ID__"],"sourceDiaries":["__DIARY_ID__"],"prompt":"结合设备测评日志和个人感悟日记，写一篇西湖VR拍摄游记，包含设备体验和拍摄建议","style":"成长复盘风","aiGenerated":true}',
...
(@travelogueId, @userId, 'JOURNEY', 'TRAVELOGUE', @diaryId,
 ...
 '{"keywords":["稻城亚丁","徒步攻略","牛奶海","高原旅行","VR全景"]}',
...
(@travelogueId, @userId, 'JOURNEY', 'TRAVELOGUE', @diaryId,
 ...
 '{"keywords":["哈巴雪山","登顶攻略","雪山攀登","向导经验","5396米"],"sourceSnapIds":["__SNAP_ID__"],"sourceDiaries":["__DIARY_ID__"],"prompt":"结合登顶技术日志和带队感悟日记，写一篇哈巴雪山深度攀登游记，包含攻略和人文感悟","style":"成长复盘风","aiGenerated":true}',
...
(@travelogueId, @userId, 'JOURNEY', 'TRAVELOGUE', @diaryId,
 ...
 '{"keywords":["长沙美食","探店攻略","臭豆腐","剁椒鱼头","文和友","湘菜"]}',
...
(@travelogueId, @userId, 'JOURNEY', 'TRAVELOGUE', @diaryId,
 ...
 '{"keywords":["苏州园林","建筑考察","VR空间设计","借景","沉浸式体验"],"sourceSnapIds":["__SNAP_ID__"],"sourceDiaries":["__DIARY_ID__"],"prompt":"结合建筑考察日志和园林感悟日记，写一篇从VR设计师视角解读苏州园林的游记","style":"诗意散文风","aiGenerated":true}',
...
(@travelogueId, @userId, 'JOURNEY', 'TRAVELOGUE', @diaryId,
 ...
 '{"keywords":["潜水攻略","蜈支洲岛","水下VR","珊瑚礁","海龟"],"sourceSnapIds":["__SNAP_ID__"],"sourceDiaries":["__DIARY_ID__"],"prompt":"结合潜水技术日志和海底感悟日记，写一篇蜈支洲岛潜水游记，包含潜水攻略和海洋保护意识","style":"温柔治愈风","aiGenerated":true}',
...
(@travelogueId, @userId, 'JOURNEY', 'TRAVELOGUE', @diaryId,
 ...
 '{"keywords":["兵马俑","秦朝","工匠精神","历史旅行","西安"],"sourceSnapIds":["__SNAP_ID__"],"sourceDiaries":["__DIARY_ID__"],"prompt":"结合历史考察日志和个人感悟日记，写一篇兵马俑深度游记，包含历史文化解读和游览建议","style":"诗意散文风","aiGenerated":true}',
...
(@travelogueId, @userId, 'JOURNEY', 'TRAVELOGUE', @diaryId,
 ...
 '{"keywords":["亚布力","滑雪攻略","旱雪","VR第一视角","极限运动"],"sourceSnapIds":["__SNAP_ID__"],"sourceDiaries":["__DIARY_ID__"],"prompt":"结合滑雪训练日志和运动感悟日记，写一篇亚布力滑雪游记，包含夏季滑雪攻略和极限运动感悟","style":"轻松口语风","aiGenerated":true}',
