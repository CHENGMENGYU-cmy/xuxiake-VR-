...
export class Post {
  ...
  @Column({ name: 'content_level', type: 'enum', enum: ['SNAPSHOT', 'POST', 'CLASSIFIED', 'DIARY', 'TRAVELOGUE', 'ESSAY'], default: 'POST' })
  contentLevel: 'SNAPSHOT' | 'POST' | 'CLASSIFIED' | 'DIARY' | 'TRAVELOGUE' | 'ESSAY';
