...
export class PostsService {
  ...
  private async getTrendingPosts(limit: number, page: number, postType?: string, tagId?: string, followingIds?: string[] | null, currentUserId?: string, excludeContentLevel?: string) {
    // 热门内容：加权热度分 + 时间衰减
