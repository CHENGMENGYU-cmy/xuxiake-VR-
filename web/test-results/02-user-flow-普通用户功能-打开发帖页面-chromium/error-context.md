      ...
      - dialog "Build Error" [ref=f1e22]:
        - generic [ref=f1e25]:
          - generic [ref=f1e26]:
            ...
            - generic [ref=f1e46]: "Unexpected token. Did you mean `{'}'}` or `&rbrace;`?"
          - generic [ref=f1e49]:
            - generic [ref=f1e51]:
              - generic [ref=f1e56]: ./src/app/(main)/upload/page.tsx (774:18)
              - button "Open in editor" [ref=f1e57] [cursor=pointer]
            - generic [ref=f1e62]:
              - generic [ref=f1e63]: "Unexpected token. Did you mean `{'}'}` or `&rbrace;`?"
              - generic [ref=f1e64]: 772 |
              - generic [ref=f1e65]: "))}"
              - generic [ref=f1e66]: 773 |
              - generic [ref=f1e67]: </select>
              - text: ">"
              - generic [ref=f1e68]: 774 |
              - generic [ref=f1e69]: ")}"
              - generic [ref=f1e70]: "|"
              - text: ^
              - generic [ref=f1e71]: 775 |
              - generic [ref=f1e72]: </div>
              - generic [ref=f1e73]: 776 |
              - generic [ref=f1e74]: ")}"
              - generic [ref=f1e75]: 777 |
              - generic [ref=f1e76]: "Parsing ecmascript source code failed Import traces: Client Component Browser: ./src/app/(main)/upload/page.tsx [Client Component Browser] ./src/app/(main)/upload/page.tsx [Server Component] Client Component SSR: ./src/app/(main)/upload/page.tsx [Client Component SSR] ./src/app/(main)/upload/page.tsx [Server Component]"
        - generic [ref=f1e77]: "1"
        - generic [ref=f1e78]: "2"
    - button "Open issues overlay" [ref=f1e85] [cursor=pointer]:
      - generic [ref=f1e89]:
        - generic [ref=f1e90]: "0"
        - generic [ref=f1e91]: "1"
      - generic [ref=f1e92]: Issue
  - alert [ref=f1e93]
```
