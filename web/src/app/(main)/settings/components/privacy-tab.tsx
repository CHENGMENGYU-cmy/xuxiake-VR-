      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <button
            ...
            className="flex items-center justify-between w-full p-3 rounded-lg border border-border hover:border-gray-300 hover:bg-gray-50 transition-colors"
          >
          ...
          <button className="flex items-center justify-between w-full p-3 rounded-lg border border-border hover:border-gray-300 hover:bg-gray-50 transition-colors">
            <div className="text-left">
