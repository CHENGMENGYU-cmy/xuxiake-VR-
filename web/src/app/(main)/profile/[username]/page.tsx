...
import { useParams, useRouter, usePathname, useSearchParams, notFound } from 'next/navigation';
...
import { followUser, unfollowUser, getFollowStatus, getOrCreateDirectConversation } from '@/lib/social-api';
        ...
        <CardContent className="relative px-4 pb-4 pt-0">
          ...
          <div className="space-y-1">
            ...
            <div className="flex gap-4 pt-2 text-sm">
              <span>
                <strong>{postCount}</strong> <span className="text-muted-foreground">帖子</span>
              </span>
