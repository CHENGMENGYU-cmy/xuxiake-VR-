...
export function Navbar() {
  ...
  const { user, isAuthenticated, authReady, logout } = useAuthStore();
  const { toggleSidebar, openUploadDialog } = useUIStore();
  ...
  }, [user, isAuthenticated, authReady, setNotifUnreadCount]);
