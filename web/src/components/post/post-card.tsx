...
import { Heart, MessageCircle, Share2, Eye, MoreHorizontal, Play, Volume2, Globe, MapPin, FileText, Compass, MessageSquare, Pencil, Trash2, Copy, Bookmark, AlertTriangle } from 'lucide-react';
