...
import { Heart, MessageCircle, Share2, Eye, EyeOff, MoreHorizontal, Play, Volume2, Globe, MapPin, FileText, Compass, MessageSquare, Pencil, Trash2, Copy, Bookmark, AlertTriangle, Image, PenLine, BookOpen } from 'lucide-react';
