...
BG = "#0F172A"            # 背景 太空灰深蓝
FRAME_BG = "#16213A"      # 大框底
FRAME_STROKE = "#38BDF8"  # 大框边框 亮蓝
USER = "#38BDF8"          # 用户圆 亮蓝
INTER_BG = "#1E293B"      # 交互模块底
INTER_STROKE = "#38BDF8"  # 交互边框 亮蓝
BLOCK_BGS = ["#1B2740", "#202C46", "#25324C", "#2A3752"]  # 四区块递进深蓝灰
BLOCK_ACCENT = "#2DD4BF"  # 区块点缀 青绿
BASE_BG = "#1E293B"       # 底座底
BASE_STROKE = "#2DD4BF"   # 底座边框 青绿
LINE = "#38BDF8"          # 主连线 亮蓝
LINE_ACCENT = "#2DD4BF"   # 次连线 青绿
TEXT_WHITE = "#F8FAFC"
TEXT_DIM = "#94A3B8"
TEXT_SUB = "#CBD5E1"
...
def main():
    ...
    for i, (title, items) in enumerate(blocks):
        ...
        S(f'<text x="{x + block_w / 2}" y="{block_y + 42}" fill="{BLOCK_ACCENT}" font-size="19" font-weight="bold" text-anchor="middle" dominant-baseline="central">{title}</text>')
